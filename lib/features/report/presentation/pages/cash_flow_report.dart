...
class _CashFlowStatementScreenState extends State<CashFlowStatementScreen> {
  CashFlowStatement cashFlowStatement = CashFlowStatement.initial();
  ...
  Widget build(BuildContext context) {
    cashFlowStatement =
        ModalRoute.of(context)!.settings.arguments as CashFlowStatement;

    return BlocProvider(
      create: (context) =>
          ReportBLoC(context.read<ReportRepository>())
            ..add(LoadReportDetailsEvent(cashFlowStatement)),
      child: Scaffold(
            ...
            builder: (context, state) {
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Text(cashFlowStatement.report_id),
                ),
              );
            },
          ),
