...
class _AccountsPayableReportScreenState
  ...
  AccountsPayable accountsPayableReport = AccountsPayable.initial();
  ...
  Widget build(BuildContext context) {
    accountsPayableReport =
        ModalRoute.of(context)!.settings.arguments as AccountsPayable;
            ...
            builder: (context, state) {
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Text(accountsPayableReport.report_id),
                ),
              );
            },
          ),
