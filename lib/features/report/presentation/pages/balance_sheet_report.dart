...
class _BalanceSheetReportScreenState extends State<BalanceSheetReportScreen> {
  BalanceSheet balanceSheetReport = BalanceSheet.initial();
  ...
  Widget build(BuildContext context) {
    balanceSheetReport =
        ModalRoute.of(context)!.settings.arguments as BalanceSheet;

    return BlocProvider(
      create: (context) =>
          ReportBLoC(context.read<ReportRepository>())
            ..add(LoadReportDetailsEvent(balanceSheetReport)),
      child: Scaffold(
            ...
            builder: (context, state) {
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Text(balanceSheetReport.report_id),
                ),
              );
            },
          ),
